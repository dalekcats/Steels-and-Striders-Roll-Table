...
void uniqueWorlds() {
float uw = random(1,31);
if(uw <= 5) {
 habitability = "Karst World"; 
}
else if(uw >= 6 && uw <= 8) {
 habitability = "Radiotropic World"; 
}
else if(uw >= 9 && uw <= 10) {
 habitability = "SuperhabitableWorld "; 
}
else if(uw >= 11 && uw <= 15) {
 habitability = "Geothermal World"; 
}
else if(uw >= 16 && uw <= 20) {
 habitability = "Archive World"; 
}
else if(uw >= 21 && uw <= 25) {
 habitability = "Boreal World"; 
}
else if(uw >= 26 && uw <= 31) {
 habitability = "Dune World"; 
}
}
void habitabilityMarker() {
float hn = random(1,50);
if( hn >=1 && hn <= 5) {
